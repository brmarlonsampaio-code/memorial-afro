...
layout = dbc.Container([
    html.H2("Sobre o Projeto", className="mb-4", style={"color": "#D4AF37", "fontFamily": "Merriweather"}),

    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.H4("Memória Afro-Brasileira", className="card-title", style={"color": "#D4AF37"}),
                    html.P([
                    ...
                    html.H5("Categorias Mapeadas", style={"color": "#D4AF37"}),
                    html.Ul([
                    ...
                    html.Hr(style={"borderColor": "#D4AF37"}),
                    html.H5("Tecnologias", style={"color": "#D4AF37"}),
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    html.H5("Estatísticas", style={"color": "#D4AF37"}),
                    html.Hr(style={"borderColor": "#D4AF37"}),
                    html.Div([
                        html.H3("15+", className="text-center", style={"color": "#D4AF37"}),
                        html.P("Pontos mapeados", className="text-center text-muted")
                    ], className="mb-3"),
                    html.Div([
                        html.H3("7", className="text-center", style={"color": "#D4AF37"}),
                        html.P("Categorias", className="text-center text-muted")
                    ], className="mb-3"),
                    html.Div([
                        html.H3("10+", className="text-center", style={"color": "#D4AF37"}),
                        html.P("Documentos catalogados", className="text-center text-muted")
                    ], className="mb-3"),
                    html.Hr(style={"borderColor": "#D4AF37"}),
                    html.H6("Contribua", style={"color": "#D4AF37"}),
